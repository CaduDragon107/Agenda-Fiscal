...
**Success Criteria** (what must be TRUE):
  ...
  5. Qualquer colaborador de DP consegue criar uma tarefa avulsa e atribuí-la a si mesmo; o DONO consegue atribuí-la a qualquer colega de DP — reaproveitando o mecanismo de tarefas avulsas já existente (confirmado: colaborador não atribui a outro colaborador, apenas o DONO atribui entre colaboradores — mesmo padrão em todos os setores).
...
**Success Criteria** (what must be TRUE):
  ...
  4. Qualquer colaborador do Contábil consegue criar uma tarefa avulsa e atribuí-la a si mesmo; o DONO consegue atribuí-la a qualquer colega do Contábil — reaproveitando o mecanismo de tarefas avulsas já existente (confirmado: colaborador não atribui a outro colaborador, apenas o DONO atribui entre colaboradores — mesmo padrão em todos os setores).
